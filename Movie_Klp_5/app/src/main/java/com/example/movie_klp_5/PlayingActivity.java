...
public class PlayingActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    ...
    public static final String VIDEO_ID = "fd5GlZUpfaM";
    ...
    public void playing(View view) {
        Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse("http://103.194.171.18/a-playing-with-fire"));
        startActivity(i);
    }

    public void back(View view) {
        Intent b = new Intent(PlayingActivity.this, FamilyActivity.class);
        startActivity(b);
    }
}
