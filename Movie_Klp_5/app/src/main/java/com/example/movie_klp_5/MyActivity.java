...
public class MyActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    ...
    public static final String VIDEO_ID = "dFGYK-iRMgw";
    ...
    public void my(View view) {
        Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse("http://103.194.171.18/my-spy"));
        startActivity(i);
    }

    public void back(View view) {
        Intent b = new Intent(MyActivity.this, FamilyActivity.class);
        startActivity(b);
    }
}
